...
def mainGame(movementInfo):
	...
	# list of upper pipes
	upperPipes = [
	# since player is a (SCREENWIDTH * 0.2)
		{'x': SCREENWIDTH * 0.7, 'y': newPipe1[0]['y']},
		{'x': SCREENWIDTH * 1.2, 'y': newPipe2[0]['y']},
	]

	# list of lowerpipe
	lowerPipes = [
		{'x': SCREENWIDTH * 0.7, 'y': newPipe1[1]['y']},
		{'x': SCREENWIDTH * 1.2, 'y': newPipe2[1]['y']},
	]
	...
	while True:
		...
		x_distance = abs(int(lowerPipes[pipeNum]['x'] - playerx))
		y_distance = abs(int(lowerPipes[pipeNum]['y'] - playery))

		if lowerPipes[pipeNum]['y'] < playery:
			side = 'upperside'
		else:
			side = 'lowerside'
